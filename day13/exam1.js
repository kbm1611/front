...
function func2( x, y ){ console.log("func4 exe"); return 10; }
let result2 = func4( );
...
// console.log ( 지역변수2 ); // fail // ReferenceError: 지역변수2 is not definece
function func5( 지역변수3 ){ // 즉] 매개변수 또한 지역변수의 특징을 갖는다.! 장점: 함수 호출/사용 시에만 메모리(저장소) 사용한다.
    let 지역변수4 = "수원시";
} // func end
func5( "안산시");
