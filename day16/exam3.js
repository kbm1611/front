...
let visitCount = 1;
visitCount = Number(sessionStorage.getItem('visit')) + 1;
visitCount = 0;
sessionStorage.setItem('visit', visitCount );

//어디에
const visitdom = document.querySelector(".visit");

//무엇을
let html = `이번 섹션에서 ${ visitCount }번째 방문입니다. `
//출력
visitdom.innerHTML = html;